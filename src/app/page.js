        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="my-6">
            ...
            <div className="text-center mb-4">
              <BlockMath
                math={
                  "\\mathbf{W}_1 = \\begin{bmatrix} \\phantom{-}0.2985 & -0.5792 \\\\[0.3em] \\phantom{-}0.0913 & \\phantom{-}0.4234 \\end{bmatrix} \\in \\mathbb{R}^{2 \\times 2}, \\quad \\mathbf{b}_1 = \\begin{bmatrix} -0.4939 & \\phantom{-}0.189\\phantom{0} \\end{bmatrix} \\in \\mathbb{R}^{1 \\times 2}"
                }
              />
            </div>
            <p className="text-sm text-gray-700 mb-2">Layer 2 parameters:</p>
            <div className="text-center mb-4">
              <BlockMath
                math={
                  "\\mathbf{W}_2 = \\begin{bmatrix} \\phantom{-}0.5266 & \\phantom{-}0.2958 \\end{bmatrix} \\in \\mathbb{R}^{1 \\times 2}, \\quad \\mathbf{b}_2 = \\begin{bmatrix} \\phantom{-}0.6358 \\end{bmatrix} \\in \\mathbb{R}^{1 \\times 1}"
                }
              />
            </div>
          </div>
          ...
          <div className="my-6">
            ...
            <p className="text-sm text-gray-700 mb-2">Then bias is added:</p>
            <div className="text-center mb-4">
              <BlockMath
                math={
                  "\\mathbf{Z}_1 = \\mathbf{Z}_1 + \\mathbf{b}_1 = \\begin{bmatrix} -0.4939 & \\phantom{-}0.1890 \\\\[0.2em] -1.0731 & \\phantom{-}0.6124 \\\\[0.2em] -0.1954 & \\phantom{-}0.2803 \\\\[0.2em] -0.7746 & \\phantom{-}0.7037 \\end{bmatrix}"
                }
              />
            </div>
            <p className="text-sm text-gray-700 mb-2">
            ...
            <div className="text-center mb-4">
              <BlockMath
                math={
                  "\\mathbf{H}_1 = \\text{LeakyReLU}_{0.5}(\\mathbf{Z}_1) = \\begin{bmatrix} -0.2470 & \\phantom{-}0.1890 \\\\[0.2em] -0.5366 & \\phantom{-}0.6124 \\\\[0.2em] -0.0977 & \\phantom{-}0.2803 \\\\[0.2em] -0.3873 & \\phantom{-}0.7037 \\end{bmatrix}"
                }
              />
            </div>
            <p className="text-sm text-gray-700 leading-relaxed">
          ...
          <div className="my-6">
            ...
            <div className="text-center mb-3">
              <BlockMath
                math={
                  "\\mathbf{z}_2 = \\mathbf{H}_1\\mathbf{W}_2^T = \\begin{bmatrix} -0.2470 & \\phantom{-}0.1890 \\\\[0.2em] -0.5366 & \\phantom{-}0.6124 \\\\[0.2em] -0.0977 & \\phantom{-}0.2803 \\\\[0.2em] -0.3873 & \\phantom{-}0.7037 \\end{bmatrix} \\begin{bmatrix} \\phantom{-}0.5266 \\\\[0.2em] \\phantom{-}0.2958 \\end{bmatrix} = \\begin{bmatrix} -0.0741 \\\\[0.2em] -0.1014 \\\\[0.2em] \\phantom{-}0.0315 \\\\[0.2em] \\phantom{-}0.0042 \\end{bmatrix}"
                }
              />
            </div>
            <p className="text-sm text-gray-700 mb-2">
            ...
            <div className="text-center mb-4">
              <BlockMath
                math={
                  "\\mathbf{z}_2 = \\mathbf{z}_2 + \\mathbf{b}_2 = \\begin{bmatrix} \\phantom{-}0.5617 \\\\[0.2em] \\phantom{-}0.5344 \\\\[0.2em] \\phantom{-}0.6673 \\\\[0.2em] \\phantom{-}0.6400 \\end{bmatrix}"
                }
              />
            </div>
            <div className="text-center mb-4">
              <BlockMath
                math={
                  "\\hat{\\mathbf{y}} = \\mathbf{h}_2 = \\text{LeakyReLU}_{0.5}(\\mathbf{z}_2) = \\begin{bmatrix} \\phantom{-}0.5617 \\\\[0.2em] \\phantom{-}0.5344 \\\\[0.2em] \\phantom{-}0.6673 \\\\[0.2em] \\phantom{-}0.6400 \\end{bmatrix}"
                }
              />
            </div>
            <p className="text-sm text-gray-700 leading-relaxed">
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="my-6">
              ...
              <div className="text-center mb-4">
                <BlockMath
                  math={
                    "\\mathcal{L} = \\frac{1}{4}[(0 - 0.5617)^2 + (1 - 0.5344)^2 + (1 - 0.6673)^2 + (0 - 0.6400)^2]"
                  }
                />
              </div>
              <div className="text-center mb-4">
                <BlockMath
                  math={
                    "\\mathcal{L} = \\frac{1}{4}[0.3155 + 0.2168 + 0.1107 + 0.4096] = 0.2631"
                  }
                />
              </div>
              <p className="text-sm text-gray-700 leading-relaxed">
            ...
            <ol className="list-decimal list-inside">
              <li>
                ...
                />{" "}
                - how much the loss changes with respect to our final
                activations.
              </li>
              <br />
              <li>
                ...
                />{" "}
                by taking the derivative of the activation (leaky ReLU in our
                case).
              </li>
              <br />
              <li>
                ...
                <InlineMath
                  math={
                    "\\frac{\\partial \\mathbf{Z}_2}{\\partial \\mathbf{H}_2}"
                  }
                />
              </li>
            </ol>
          ...
          <p>
            ...
            them together to find any derivative with respect of the loss (i.e.{" "}
            <InlineMath
              math={
                "\\frac{\\partial \\mathcal{L}}{\\partial \\mathbf{H}_2} \\cdot \\frac{\\partial \\mathbf{H}_2}{\\partial \\mathbf{Z}_2} \\cdot \\frac{\\partial \\mathbf{Z}_2}{\\partial \\mathbf{W}_2}"
              }
            />{" "}
            gives us{" "}
            <InlineMath
              math={"\\frac{\\partial \\mathcal{L}}{\\partial \\mathbf{W}_2}"}
            />
            ).
          </p>
          ...
          <p>
            ...
            <InlineMath
              math={"\\frac{\\partial \\mathbf{H}_2}{\\partial \\mathbf{Z}_2}"}
            />
            ...
            it exactly like the loss module (and bias and activation modules),
          ...
          <p>
            Now you might be wondering — how do we actually compute derivatives
            in hardware? Let&apos;s look at Leaky ReLU as an example, since
            it&apos;s beautifully simple but demonstrates the key principles.
            Remember that Leaky ReLU applies different operations based on
            whether the input is positive or negative. The derivative follows
            the same pattern: it outputs 1 for positive inputs and a small
            constant (we used 0.01) for negative inputs.
          </p>
          <div className="my-6">
            <p className="text-sm text-gray-700 mb-2">
          ...
          <p>
            ...
            comparison – no complex arithmetic needed. The hardware can compute
          ...
          <p>
            ...
            that sit underneath the systolic array process column vectors that
          ...
          <p>
            ...
            accumulators, as well as manually loading the bias and leak factors
            into their respective modules, by using the UB to store them. This
            is also better practice, rather than loading in new data every clock
            cycle with the instruction set. Since we want to access two values
            (2 inputs or 2 weights for each row/col of the systolic array) at
            the same time, we added TWO read and write ports. We did this for
            each data primitive (inputs, weights, bias, leak factor, post
            activations) to minimize data contention since we have many
          ...
          <p>
            ...
            only use the <InlineMath math={"\\mathbf{H}_2"} /> values once (for
            computing{" "}
            <InlineMath
              math={"\\frac{\\partial \\mathbf{H}_2}{\\partial \\mathbf{Z}_2}"}
            />
            ), we created a tiny cache within the VPU instead of storing them in
            the UB. The rest of the <InlineMath math={"\\mathbf{H}"} /> values
            will be stored in the UB because they&apos;re needed to compute
          ...
          <p>
            This is what the new TPU architecture, modified to perform training,
            looks like:
          </p>
          <figure className="mt-12">
          ...
          <p>
            ...
            how do we calculate bias gradients?&quot; Well, we&apos;ve actually
            already done most of the work! Since we&apos;re processing batches
            of data, we can simply sum (the technical term is
            &quot;reduce&quot;) the{" "}
            <InlineMath
              math={"\\frac{\\partial \\mathcal{L}}{\\partial \\mathbf{Z}_n}"}
            />{" "}
          ...
          <p>
            ...
            exactly how we want. The same systolic array that powered our
            inference now powers our training, with just a few additional
            modules to handle the gradient computations.
          </p>
          <p>
            What started as a simple idea about matrix multiplication has grown
            into a complete training system. Every component works together in
